                            ...
                            <div class="box">
                                <div class="box-header">
                                    <div style="padding:10px;">
                                        <?php
                                        $cm = '';
                                        $userr = mysqli_query($con,"SELECT * from student where student_id = '".$_SESSION['userid']."' ");
                                    while($rowr = mysqli_fetch_array($userr)){
                                         $cm = $rowr['student_asta'];
                                    } 
                                    if ($cm == 0) {?>

                                        <button class="btn btn-primary btn-sm" data-toggle="modal" style="background-color:#bcaa3c;" > Pending Approval</button>  
                                         
                                        
                                   <?php }elseif ($cm == 2) {?>
                                       <button class="btn btn-primary btn-sm" data-toggle="modal" style="background-color:#d70f0fc2;">Registration Rejected</button>
                                  <?php }
                                  else{

                                    ?>
                                        
                                        <button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#addregister"><i class="fa fa-plus" aria-hidden="true"></i> Register Course</button>  
