                            ...
                            <div class="box">
                                ...
                                <form method="post">
                                    <table id="course_table" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            <?php
                                            $squery = mysqli_query($con, "SELECT * from report inner join course on report.report_cid = course.course_id where report.report_uid = '".$_SESSION['userid']."' and report.report_sta = 1
                                                ");
