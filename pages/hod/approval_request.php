                        ...
                        <!-- left column -->
                            <div class="box">
                                ...
                                <form method="post">
                                    ...
                                    JOIN level ON student.student_level_id = level.level_id where student.student_asta=0");
                                            while($row = mysqli_fetch_array($squery))
                                            {
                                                ...
                                                <tr>
                                                    ...
                                                    <td>'.$row['lname'].'</td>
                                                    <td>'.$row['pname'].'</td>
                                                     <td><button class="btn btn-primary btn-sm" data-target="#editstudent'.$row['student_id'].'" data-toggle="modal"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> View</button>
