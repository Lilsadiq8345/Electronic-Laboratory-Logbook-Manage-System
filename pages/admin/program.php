...
<html>
    ...
    <body class="skin-black">
        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
                            ...
                            <div class="box">
                                <div class="box-header">
                                    <div style="padding:10px;">
                                        ...
                                        <button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#addprogram"><i class="fa fa-plus" aria-hidden="true"></i> Add Program</button>  
                                ...
                                <form method="post">
                                    <table id="course_table" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            <?php
                                            $squery = mysqli_query($con, "SELECT * FROM program ");
                                            while($row = mysqli_fetch_array($squery))
                                            {
                                                echo '
                                                <tr>
                                                    <td><input type="checkbox" name="chk_delete[]" class="chk_delete" value="'.$row['program_id'].'" /></td>
                                                    <td>'.$row['program_name'].'</td>
                                                    <td>'.$row['program_added_on'].'</td>
                                                     <td><button class="btn btn-primary btn-sm" data-target="#editprogram'.$row['program_id'].'" data-toggle="modal"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button>
            ...
            <?php include "program_function.php"; ?>
