                    ...
                    <div class="row">
                        <!-- left column -->
                            <div class="box">
                                <div class="box-header">
                                    <div style="padding:10px;">
                                        ...
                                        <button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#addsemester"><i class="fa fa-plus" aria-hidden="true"></i> Add Semester</button>  
                                ...
                                <form method="post">
                                    <table id="course_table" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            <?php
                                            $squery = mysqli_query($con, "SELECT * FROM semester ");
                                            while($row = mysqli_fetch_array($squery))
                                            {
                                                echo '
                                                <tr>
                                                    <td><input type="checkbox" name="chk_delete[]" class="chk_delete" value="'.$row['semester_id'].'" /></td>
                                                    <td>'.$row['semester_name'].'</td>
                                                    <td>'.$row['semester_added_on'].'</td>
                                                     <td><button class="btn btn-primary btn-sm" data-target="#editsemester'.$row['semester_id'].'" data-toggle="modal"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button>
                            ...
                            <div class="alert alert-success alert-autocloseable-success" style=" position: fixed; top: 1em; right: 1em; z-index: 9999; display: none;">
                                 Edited Semester Saved!
                            </div>
                            <?php include "../added_notif.php"; ?>

                            <?php include "../delete_notif.php"; ?>

            <?php include "add_semester.php"; ?>

            <?php include "semester_function.php"; ?>
