...
<html>
    ...
    <body class="skin-black">
        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
                            ...
                            <div class="box">
                                <div class="box-header">
                                    <div style="padding:10px;">
                                        ...
                                        <button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#addlevel"><i class="fa fa-plus" aria-hidden="true"></i> Add Level</button>  
                                ...
                                <form method="post">
                                    <table id="course_table" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            <?php
                                            $squery = mysqli_query($con, "SELECT * FROM level ");
                                            while($row = mysqli_fetch_array($squery))
                                            {
                                                echo '
                                                <tr>
                                                    <td><input type="checkbox" name="chk_delete[]" class="chk_delete" value="'.$row['level_id'].'" /></td>
                                                    <td>'.$row['level_name'].'</td>
                                                    <td>'.$row['level_addedon'].'</td>
                                                     <td><button class="btn btn-primary btn-sm" data-target="#editlevel'.$row['level_id'].'" data-toggle="modal"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button>
                                                    </td>
            ...
            <?php include "level_function.php"; ?>
