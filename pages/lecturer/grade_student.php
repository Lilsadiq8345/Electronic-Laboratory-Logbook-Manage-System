                                ...
                                <form method="post">
                                    <table id="course_table" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            {
                                                $stquery = mysqli_query($con, "SELECT * from report inner join student on report.report_uid = student.student_id where report.report_uid = '".$_SESSION['userid']."' and report.report_sta = 0
                                                ");
                                            while($trow = mysqli_fetch_array($stquery))
                                            {
                                                ...
                                                <tr>
                                                    ...
                                                    <td><button class="btn btn-primary btn-sm" data-target="#sreport'.$row['report_id'].'" data-toggle="modal"><i class="fa fa-eye" aria-hidden="true"></i> Grade Report</button>
...
<?php include "grade_function.php"; ?>
