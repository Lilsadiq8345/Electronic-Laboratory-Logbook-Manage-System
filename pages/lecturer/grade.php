    ...
    <div class="modal-content">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" style="border-radius:0px" name="report_labnumber" value="<?php echo $trow['student_matricnumber'];  ?>" disabled required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  <label for="txt_username">Enter Grade Marks(20marks)</label>
                  <input type="number" class="form-control" style="border-radius:0px" name="grade"   required>
                </div>
        ...
        <div class="modal-footer">
            <input type="button" class="btn btn-default btn-sm" data-dismiss="modal" value="Cancel"/>
             <input type="submit" class="btn btn-primary btn-sm" name="grade_" id="grade_" value="Grade"/>
