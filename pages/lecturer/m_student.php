                            ...
                            <div class="box">
                                ...
                                <form method="post">
                                    <table id="course_table" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            <?php
                                            $squery = mysqli_query($con, "SELECT * from student inner join course_registration on student.student_id = course_registration.registration_uid inner join allocation on course_registration.registration_cid = allocation.allocation_cid where allocation.allocation_lid = '".$_SESSION['userid']."'
                                                ");
